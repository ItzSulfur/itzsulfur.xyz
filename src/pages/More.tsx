function More() {
    ...
    return (
      <>
        ...
        <a href="https://github.com/ItzSulfur">
          <span className="[&>svg]:h-5 [&>svg]:w-5 hover:text-purple-500">
            <svg
        ...
        <br />
        <p>These are the social platforms I am active on, and where you can reach out.</p>
      </>
    )
    }
